...
{
    m_TnCounter = TopologicalNumberImageFunction<TImage, TForegroundConnectivity>::New();
}
...
{
//     m_tnCounter->SetInputImage(GetInputImage());
    std::pair<unsigned char, unsigned char> const result = m_TnCounter->EvaluateAtIndex(index);
