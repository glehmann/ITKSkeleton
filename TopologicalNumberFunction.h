#ifndef TopologicalNumberFunction_h
#define TopologicalNumberFunction_h
...
public :
     ...
     */
    //@{
    std::pair<unsigned int, unsigned int> Evaluate(PointType const & point) const;
    
    std::pair<unsigned int, unsigned int> EvaluateAtIndex(IndexType const & index) const;
    
    std::pair<unsigned int, unsigned int> EvaluateAtContinuousIndex(ContinuousIndexType const & contIndex) const;
    //@}

    /**
     * @name Selectors for the computation of fore- and background topological numbers.
     *
...
#include "TopologicalNumberFunction.txx"

#endif // TopologicalNumberFunction_h
